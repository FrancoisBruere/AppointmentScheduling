...
namespace AppointmentScheduling.Controllers.Api
{
    ...
    {
        // dependency injection to get appointmentservice
        ...
        {
            CommonResponse<int> commonResponse = new CommonResponse<int>(); // for appointment messages
            try
            {
                commonResponse.status = _appointmentService.AddUpdate(data).Result; // will retrieve record update result and save in status returns 1 or 2
        ...
        [HttpGet]
        [Route("GetCalendarDataById/{id}")] // for opening calendar appointment made
        ...
        [HttpGet]
        [Route("DeleteAppointment/{id}")] // for opening calendar appointment made
        ...
        [HttpGet]
        [Route("ConfirmEvent/{id}")] // for opening calendar appointment made
